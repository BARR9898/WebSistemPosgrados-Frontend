...
export class CreateComponentComponent implements OnInit {
  ...
  constructor(
    ...
    this.buildForm();
    console.log(this.form.controls.NADocentes['controls'])
  }
  ...
  saveMaster(name_master:HTMLInputElement) {
    console.log(name_master.value);
  ...
  private buildForm() {
    ...
    this.formBuilder.group({
      ...
      Estudiante: this.formBuilder.array([
        this.formBuilder.group({
          'generacion': this.formBuilder.control('1',
            [Validators.required,
      ...
      Imagenes: this.formBuilder.array([
        this.formBuilder.group({
          'title': this.formBuilder.control('Esta es información de ejemplo',
            [Validators.required,
            Validators.minLength(5)]),
          'description': this.formBuilder.control('Esta es información de ejemplo',
            [Validators.required,
            Validators.minLength(5)]),
  ...
  addNADocente() {
    ...
    let newDocente = this.formBuilder.group({
      ...
      'DINombre': 'Esta es información de ejemplo',
      'DIDescripcion': 'Esta es información de ejemplo',
      'DIPath':''
    })
